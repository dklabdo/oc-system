...
import profile from "../assets/module.svg";
    ...
    <table className="   w-full ">
      <thead className="    h-10 rounded-2xl  ">
        <tr className=" w-full rounded-2xl text-left border-b-[1.2px] border-gray-300 ">
          <th className="pl-2 w-16 bg-[#D0DCEE] rounded-tl-2xl text-sm font-medium text-gray-700 "></th>
          <th className="bg-[#D0DCEE] pl-2  text-sm font-medium text-gray-700 ">
            Module
          </th>
          <th className="bg-[#D0DCEE] pl-2  text-sm font-medium text-gray-700 ">
            Coef
          ...
          <th className="bg-[#D0DCEE] pl-5 rounded-tr-2xl  text-sm font-medium text-gray-700 ">
            Action
          </th>
        </tr>
      </thead>
      <tbody>
        <tr className=" border-b-[1.2px] border-gray-200 hover:bg-gray-50 cursor-pointer ">
          ...
          <td className="pl-2   gap-2 py-3 text-sm font-medium text-gray-900 ">
            <div className="flex items-center gap-2" >
              <span className="inline">
                <img className="w-7" src={profile} alt="..." />
              </span>
              <span>Algorthme avance</span>
            </div>
          </td>
          <td className="pl-3 py-3 text-sm font-medium text-gray-900 ">6</td>
          <td className="pl-3 py-3 text-sm font-medium text-gray-900 "> 5</td>
          <td className="pl-4 py-3 rounded-br-2xl text-sm font-medium text-gray-900 ">
            {" "}
            <ModuleAction />{" "}
          </td>
        </tr>
